...
class AppUser {
  ...
  factory AppUser.fromSnapshot(DocumentSnapshot documentSnapshot) {
    return AppUser(
      photoUrl:documentSnapshot['photoUrl'] ?? 'default',
    email:documentSnapshot['email'] ?? '',
    division:documentSnapshot['division'] ?? '',
    id:documentSnapshot['id'] ?? '',
    enrollNo:documentSnapshot['enrollNo'] ?? '',
    firebaseUuid:documentSnapshot['firebaseUuid'] ?? '',
    displayName:documentSnapshot['displayName'] ?? '',
    standard:documentSnapshot['standard'] ?? '',
    dob:documentSnapshot['dob'] ?? '',
    guardianName:documentSnapshot['guardianName'] ?? '',
    bloodGroup:documentSnapshot['bloodGroup'] ?? '',
    mobileNo:documentSnapshot['mobileNo'] ?? '',
    isTeacher:documentSnapshot['isTeacher'] ?? false,
    isVerified:documentSnapshot['isVerified'] ?? false,
    connection:documentSnapshot['connection'] ?? {},
    );
  }
