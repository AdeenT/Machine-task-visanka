...
class StudentConnectionPage extends StatefulWidget {
  StudentConnectionPage({required this.model, required this.documentSnapshot,  this.color});
...
class _StudentConnectionPageState extends State<StudentConnectionPage> {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            ...
            image: _buildImage(url, userType)
          ),
        ),
      ),
    );
 ...
 ImageProvider<Object> _buildImage(String url, UserType userType){
  if(url != 'default'){
    return NetworkImage(url);
  }else if(userType == UserType.STUDENT){
    return  AssetImage(assetsString.student_welcome);
  }else{
    return  AssetImage(assetsString.parents_welcome);
  }
 }
}
