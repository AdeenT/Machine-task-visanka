...
class HolidayDetailsPageState extends State<HolidayDetailsPage>
  ...
  late List<List<Holiday>> listOfHolidayLists;
  late List<Holiday> currentMonthHolidayList;
  late Animation<double> dividerIndentAnimation;
