...
export 'package:firebase_core/firebase_core.dart';        //  Changed
export 'package:cloud_firestore/cloud_firestore.dart';    //  Changed
...
export 'core/helpers/FirebaseAnalytics.dart';             // Changed
...
export 'core/services/AuthenticationServicesMysql.dart';
export 'core/viewmodel/LoginPageModel.dart';
export 'core/helpers/shared_preferences_helper.dart';
export 'core/services/AnnouncementServicesMysql.dart';
